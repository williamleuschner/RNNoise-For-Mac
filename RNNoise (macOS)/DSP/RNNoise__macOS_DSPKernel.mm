...
#import "RNNoise__macOS_DSPKernel.hpp"
#import "Helpers/RNNoise__macOS_DSPKernelAdapter.h"

@implementation RNNoise__macOS_DSPKernelAdapter {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    RNNoise__macOS_DSPKernel  _kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block RNNoise__macOS_DSPKernel *state = &_kernel;
